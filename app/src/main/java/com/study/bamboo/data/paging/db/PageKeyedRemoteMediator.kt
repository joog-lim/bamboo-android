...
//    }
//
//    override suspend fun load(loadType: LoadType, state: PagingState<Int, AcceptEntity>): MediatorResult {
//
...
//
//            val repos = apiResponse.posts
//
//            val acceptEntity=AcceptEntity(
//                repos
//            )
...
//                    repoDatabase.adminDao().acceptPostClear()
//                }
...
//                repoDatabase.adminDao().insertAcceptPost(acceptEntity)
//            }
